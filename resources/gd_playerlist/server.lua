...
local rank_special = {
    ...
    -- Police dept
    ["Police Commissioner"] =   {suffix = {x=21,y=0}, fullcolor = "blue", title = "Police Commissioner"},
    ["Deputy Commissioner"] =   {suffix = {x=21,y=0}, fullcolor = "blue", title = "Deputy Commissioner"},
    ["Inspector"] =   {suffix = {x=21,y=0}, fullcolor = "blue", title = "Inspector"},
    ["Captain"] =    {suffix = {x=21,y=0}, color = "blue", title = "Captain"},
    ["Lieutenant"] = {suffix = {x=21,y=0}, color = "blue", title = "Lieutenant"},
    ["Sergeant"] =   {suffix = {x=21,y=0}, color = "blue", title = "Sergeant"},
    ["Detective 1st Class"] =  {suffix = {x=21,y=0}, color = "blue", title = "Detective 1st Class"},
    ["Police Officer"] =    {suffix = {x=21,y=0}, color = "blue", title = "Police Officer"},
    ["Recruit"] =             {suffix = {x=21,y=0}, color = "blue", title = "Recruit"},
    ["Dispatcher"] =        {suffix = {x=14,y=36}, color = "white", title = "Dispatcher"},

    -- State Police dept
    ["Superintendent"] =   {suffix = {x=24,y=0}, fullcolor = "purple", title = "Superintendent"},
    ["Deputy Superintendent"] =   {suffix = {x=24,y=0}, fullcolor = "purple", title = "Deputy Superintendent"},
    ["Staff Inspector"] =   {suffix = {x=24,y=0}, fullcolor = "purple", title = "Staff Inspector"},
    ["State Police Captain"] =    {suffix = {x=24,y=0}, color = "purple", title = "Captain"},
    ["State Police Lieutenant"] = {suffix = {x=24,y=0}, color = "purple", title = "Lieutenant"},
    ["State Police Sergeant"] =   {suffix = {x=24,y=0}, color = "purple", title = "Sergeant"},
    ["Investigator"] =  {suffix = {x=24,y=0}, color = "purple", title = "Investigator"},
    ...
    ["Fire Captain"] =    {suffix = {x=23,y=0}, color = "red", title = "Captain"},
    ["Fire Lieutenant"] = {suffix = {x=23,y=0}, color = "red", title = "Lieutenant"},
    ["Driver Engineer"] =   {suffix = {x=23,y=0}, color = "red", title = "Driver Engineer"},
    ["Firefighter"] =  {suffix = {x=23,y=0}, color = "red", title = "Firefighter"},
    ["Probationary Firefighter"] =    {suffix = {x=23,y=0}, color = "red", title = "Probationary Firefighter"},

    -- NYEMS
    ["EMS Batallion Chief"] =   {suffix = {x=2,y=41}, fullcolor = "red", title = "Batallion Chief"},
    ["EMS Assistant Batallion Chief"] =   {suffix = {x=2,y=41}, fullcolor = "red", title = "Assistant Chief"},
    ["EMS Captain"] =   {suffix = {x=2,y=41}, fullcolor = "red", title = "Batallion Chief"},
    ["EMS Lieutenant"] =    {suffix = {x=2,y=41}, color = "red", title = "Captain"},
    ["Paramedic FTO"] = {suffix = {x=2,y=41}, color = "red", title = "Lieutenant"},
    ["Paramedic"] =   {suffix = {x=2,y=41}, color = "red", title = "Driver Engineer"},
    ["EMT"] =  {suffix = {x=2,y=41}, color = "red", title = "Firefighter"},
